...
var accordion = (node) => {
  ...
  var _handleAnimation = (e) => {
    var { parentNode: group, nextElementSibling: content } = e.currentTarget;
    e.preventDefault();
    slideStop(content);
...
function w(n, a) {
  return (
    ...
    void 0 === p && (p = d),
    void 0 === f && (f = r$2),
    (a || o$1 !== t$5 || e$2 !== i || r$2 !== f || d !== p) &&
      (!(function (n) {
        for (var w = 0; w < u$1.length; w++)
          u$1[w](
            { x: e$2, y: o$1, px: i, py: t$5, vh: r$2, pvh: f, vw: d, pvw: p },
            n
          );
      })(n),
      (i = e$2),
...
function srraf(e) {
  return (
    u$1.indexOf(e) < 0 && u$1.push(e),
    (n$2 = n$2 || w(performance.now())),
    {
      update: function () {
        return w(performance.now(), !0), this;
      },
      destroy: function () {
        u$1.splice(u$1.indexOf(e), 1);
      },
    }
  );
}
...
var stickyHeader = (node) => {
  ...
  var _initStickyHeader = (offsets) => {
    var { scrollYToSticky, offsetHeight, stickyHeaderResetPosition } = offsets; // Destroy stickyScroller if one already exists
...
var headerOverlay = (node) => {
  if (!node) return;
  var overlay = node;
  var overlayShowListener = c$1(events.headerOverlay.show, () =>
    _showOverlay()
  );
  var overlayHideListener = c$1(events.headerOverlay.hide, () =>
    _hideOverlay()
  );
...
var drawerOverlay = (node) => {
  ...
  var overlayShowListener = c$1(events.drawerOverlay.show, () =>
    _showOverlay()
  );
  var overlayHideListener = c$1(events.drawerOverlay.hide, () =>
    _hideOverlay()
  );
...
var getCandidates = function getCandidates(el, includeContainer, filter) {
  var candidates = Array.prototype.slice.apply(
    el.querySelectorAll(candidateSelector$1)
  );
...
var isNodeMatchingSelectorFocusable$1 =
  function isNodeMatchingSelectorFocusable(options, node) {
    if (
      node.disabled ||
      isHiddenInput$1(node) ||
      isHidden$1(node, options.displayCheck) || // For a details element with a summary, the summary element gets the focus
...
var isNodeMatchingSelectorTabbable$1 = function isNodeMatchingSelectorTabbable(
  options,
  node
) {
  if (
    !isNodeMatchingSelectorFocusable$1(options, node) ||
    isNonTabbableRadio$1(node) ||
    getTabindex$1(node) < 0
  ) {
    return false;
  }
...
var tabbable$1 = function tabbable(el, options) {
  ...
  var candidates = getCandidates(
    ...
    isNodeMatchingSelectorTabbable$1.bind(null, options)
  );
...
var focusable = function focusable(el, options) {
  ...
  var candidates = getCandidates(
    el,
    options.includeContainer,
    isNodeMatchingSelectorFocusable$1.bind(null, options)
  );
  return candidates;
};
...
var focusableCandidateSelector$1 = /* #__PURE__ */ candidateSelectors$1
  .concat("iframe")
  .join(",");
...
function c(n) {
  ...
  a.formats = Object.assign({}, m, a.formats);
  var r,
    _ =
      (void 0 === (r = a.storageKey) && (r = "currency"),
      {
        key: r,
        read: function () {
  ...
  return {
    ...
    setCurrent: e,
    convertAll: function (m, n, r, _) {
      if ((void 0 === _ && (_ = a.format), "undefined" == typeof Currency))
        throw new Error(
          "Can't access Shopify Currency library. Make sure it's properly loaded."
        );
      n &&
        ((r || document.querySelectorAll("span.money")).forEach(function (r) {
          if (r.dataset.current !== n) {
            if (Boolean(r.dataset["currency" + t$3(n)]))
              return (
                (r.innerHTML = r.dataset["currency" + t$3(n)]),
                void (r.dataset.currency = n)
              );
            var e,
              u = a.formats[m][_] || "{{amount}}",
              y = a.formats[n][_] || "{{amount}}",
              c = function (o) {
                return Currency.convert(o, m, n);
              },
              f = parseInt(r.innerHTML.replace(/[^0-9]/g, ""), 10);
            e =
              -1 !== u.indexOf("amount_no_decimals")
                ? c(100 * f)
                : ["JOD", "KWD", "BHD"].includes(m)
                ? c(f / 10)
                : c(f);
            var i = formatMoney_1(e, y);
            (r.innerHTML = i),
              (r.dataset.currency = n),
              r.setAttribute("data-currency-" + n, i);
          }
        }),
        e(n));
    },
...
var formatMoney$1 = (val) =>
  formatMoney_1(val, theme.moneyFormat || "${{amount}}");
...
function quantityInput(quantitySelector, container) {
  ...
  var addQuantity = quantityWrapper.querySelector(
    ".product-form__quantity-add-item"
  );
  var subtractQuanity = quantityWrapper.querySelector(
...
function updateBuyButton(node, variant) {
  ...
  var { langAvailable, langSoldOut, langUnavailable } = btn.dataset;
...
var formatMoney = (val) =>
  formatMoney_1(val, window.theme.moneyFormat || "${{amount}}");
...
function switchImage(container, imageId) {
  var newImage = n$3(
    selectors$1h.imageWrapper + selectors$1h.imageById(imageId),
    container
  );
  var newImageMedia = n$3(".media", newImage);
  var otherImages = t$6(
    ""
      .concat(selectors$1h.imageWrapper, ":not(")
      .concat(selectors$1h.imageById(imageId), ")"),
    container
  );
...
function createOptionGroup(el) {
  ...
  var buttonClick = e$3(buttons, "click", (e) => {
    e.preventDefault();
    var { button } = e.currentTarget.dataset;
...
var inventoryCounter = (container, config) => {
  ...
  function checkThreshold(_ref) {
    var { inventory_policy, inventory_quantity, inventory_management } = _ref;
...
var selectors$1e = {
  ...
  inputWrapWithValue: (option) =>
    "".concat(selectors$1e.inputWrap, '[data-index="').concat(option, '"]'),
  buttonWrap: "[dynamic-variant-button]",
  buttonWrapWithValue: (value) =>
    ""
      .concat(selectors$1e.buttonWrap, '[data-option-value="')
      .concat(value, '"]'),
};
/**
 *  VariantAvailability
...
function variantAvailability(container) {
  ...
  var { enableDynamicProductOptions, currentVariantId } =
    variantsWrapper.dataset;
  if (enableDynamicProductOptions === "false") return;
  var productVariants = JSON.parse(
    n$3(selectors$1e.variantsJson, container).innerText
  ...
  function setInitialAvailability() {
    ...
    var initiallySelectedVariant = productVariants.find(
      (variant) => variant.id === parseInt(currentVariantId, 10)
    );
    var currentlySelectedValues = initiallySelectedVariant.options.map(
      (value, index) => {
        return {
          value,
    ...
    var initialOptions = createAvailableOptionsTree(
      productVariants,
  ...
  function setAvailability(selectedValues) {
    ...
    var valuesToManage = createAvailableOptionsTree(
      productVariants,
      selectedValues
  ...
  function disableVariantGroup(group) {
    if (a$1(group, "product-form__option-select-wrapper")) return;
    t$6(selectors$1e.buttonWrap, group).forEach((button) =>
      u$2(button, classes$m.disabled)
    );
  }
...
var intersectionWatcher = function (node) {
  ...
  var observer = new IntersectionObserver(
    (_ref) => {
      var [{ isIntersecting: visible }] = _ref;
...
var animateCarousel = (node) => {
  ...
  if (a$1(node, "carousel--columns-wrap-around")) {
    offsetSelectors = [
      selectors$1d.sectionBlockItems,
      "".concat(selectors$1d.slide, ":last-of-type"),
      "".concat(selectors$1d.slide, ":not(:last-of-type)"),
    ];
  }
...
var animateBlogPosts = (node) => {
  ...
  if (a$1(node, "carousel--columns-wrap-around")) {
    offsetSelectors = [
      "".concat(selectors$14.slide, ":last-of-type"),
      "".concat(selectors$14.slide, ":not(:last-of-type)"),
    ];
  }
...
var animateFeaturedCollectionRow = (node) => {
  if (!shouldAnimate(node)) return;
  var { textAlignment } = node.dataset;
  ...
  if (textAlignment === "right") {
    delayOffset(node, [
      ""
        .concat(selectors$10.slide, ":nth-child(n+")
        .concat(slides.length - columns + 1, ")"),
      selectors$10.sectionIntro,
    ]);
  } else {
    delayOffset(node, [
      selectors$10.sectionIntro,
      "".concat(selectors$10.slide, ":nth-child(-n+").concat(columns, ")"),
    ]);
  }
...
var animateLocation = (node) => {
  ...
  delayOffset(node, [
    selectors$Y.sectionIntroduction,
    selectors$Y.image,
    selectors$Y.map,
    selectors$Y.cta,
  ]);
...
var animateShoppable = (node) => {
  if (!shouldAnimate(node)) return;
  var animationItems = [
    selectors$U.animateBackground,
    selectors$U.sectionIntro,
    selectors$U.image,
    selectors$U.shoppableItems,
  ];
...
var animateVideoHero = (node) => {
  ...
  delayOffset(
    node,
    [selectors$S.animateBackground, selectors$S.sectionBlockItems],
    3
  );
  var observer = intersectionWatcher(node);
  return {
...
var animateSlideshow = (node) => {
  ...
  slides.forEach((slide) => {
    ...
    delayOffset(
      slide,
      [selectors$R.animateBackground, selectors$R.sectionBlockItems],
      3
    );
  });
  var observer = intersectionWatcher(node);
...
var animateSlideshowSplit = (node) => {
  ...
  delayOffset(
    node,
    [selectors$Q.animateBackground, selectors$Q.sectionBlockItems],
    3
  );
  var observer = intersectionWatcher(node);
  return {
...
var animateBlog = (node) => {
  if (!shouldAnimate(node)) return;
  delayOffset(node, [
    selectors$N.headerItems,
    selectors$N.articleItem,
    selectors$N.pagination,
  ]);
  var observer = intersectionWatcher(node, true);
  return {
    destroy() {
...
var animateArticle = (node) => {
  ...
  delayOffset(node, [
    selectors$M.articleHeaderItems,
    selectors$M.articleImage,
    selectors$M.articleContent,
  ]);
...
var carousel = function carousel(node) {
  var { carouselPosition = "bottom" } =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var carousel = null;
  var carouselAnimation = null;
  var { textPosition, textAlignment } = node.dataset;
  ...
  var _updateNavigationPosition = (carouselHeight) => {
    ...
    var containerPadding = parseFloat(
  ...
  var unload = () => {
    ...
    carousel.destroy();
    (_carouselAnimation = carouselAnimation) === null ||
    _carouselAnimation === void 0
      ? void 0
      : _carouselAnimation.destroy();
  ...
  function handleRecommendedProducts() {
    ...
    fetch(requestUrl)
      ...
      .then((text) => {
        ...
        html.innerHTML = text;
        var recommendations = n$3(
          selectors$F.complementaryProductsContent,
          html
        );
...
var renderLineDiscounts = (discounts) => {
  if (Boolean(discounts.length)) {
    var formatted_discounts = discounts.map((_ref) => {
      ...
      return "<li>"
        .concat(title, " (-")
        .concat(formatMoney$1(amount), ")</li>");
    });
...
function createItem(_ref2, highlightProduct) {
  ...
  var sellingPlanName = selling_plan_allocation
  ...
  return (
    ...
    "\n    <div class='cart__item"
      ...
      .concat(formatMoney$1(price), " <span>")
      .concat(priceQuanity, "</span>\n              </span>\n              ")
      .concat(
...
function createRecent(_ref3) {
  var { handle, title, url, featured_image: image } = _ref3,
...
function renderDiscounts(discounts) {
  return discounts.length > 0
    ? "\n    <div>\n      ".concat(
        discounts.map((_ref) => {
          var { title, total_allocated_amount: value } = _ref;
          return "<div>"
            .concat(title, " (-")
            .concat(formatMoney$1(value), ")</div>");
        }),
        "\n    </div>\n  "
      )
    : "";
...
var cartDrawer = (node) => {
  ...
  var render = (cart) => {
    var { cart_level_discount_applications: cart_discounts } = cart;
    ...
    cartDrawerAnimation === null || cartDrawerAnimation === void 0
      ? void 0
  ...
  render(u().cart);
  tabLinkCart.addEventListener(
    "click",
    (e) => e.preventDefault() || viewCart()
  );
  ...
  c$1("cart:toggle", (_ref2) => {
    var { cart, cartOpen } = _ref2;
    cartOpen ? open(cart) : close();
  });
  c$1("cart:updated", (_ref3) => {
    var { cartOpen, cart } = _ref3;
...
var modal = (node) => {
  ...
  var accordions = [];
  var events = [
    e$3(n$3(selectors$D.closeBtn, node), "click", (e) => {
      e.preventDefault();
    ...
    c$1("drawerOverlay:hiding", () => _close(false)),
    c$1("modal:open", (state, _ref2) => {
      var { modalContent } = _ref2;
  ...
  var _initAccordion = () => {
    ...
    var accordionElements = modalContent.querySelectorAll(
      selectors$D.accordion
    );
...
function ProductForm(form, prod) {
  ...
  var quantityInputs = initInputs(
    selectors$C.quantityInput,
    config.onQuantityChange
  );
  var propertyInputs = initInputs(
...
var { strings: strings$4 } = window.theme;
var selectors$A = {
...
var ShippingEstimator = (node, container) => {
  ...
  if (firstCountryOptions.length > 1) {
    ...
    firstCountryOptions[0].innerText =
      strings$4.products.product.country_placeholder;
  }
  ...
  var events = [
    ...
    e$3(n$3(selectors$A.close, node), "click", _close),
    e$3(estimate, "click", _estimateShipping),
    e$3(modal, "keydown", (_ref) => {
      var { keyCode } = _ref;
      if (keyCode === 27) _close();
    }),
  ];
  ...
  var getRates = (variantId) => {
    ...
    fetch(routes.add + ".js", {
      ...
      .then(() => {
        ...
        var countryQuery = "shipping_address%5Bcountry%5D=".concat(
          countrySelector.value
        );
        var provinceQuery = "shipping_address%5Bprovince%5D=".concat(
          provinceSelector.value
        );
        var zipQuery = "shipping_address%5Bzip%5D=".concat(zipInput.value);
        var requestUrl = ""
          .concat(routes.shipping, ".json?")
          .concat(countryQuery, "&")
        ...
        request.onload = () => {
          ...
          if (request.status >= 200 && request.status < 300) {
            if (response.shipping_rates && response.shipping_rates.length) {
              ...
              var noRate =
                '\n                <li class="shipping-estimator-modal__success-item">\n                  <span>'.concat(
                  strings$4.products.product.no_shipping_rates,
                  "</span>\n                </li>\n              "
                );
  ...
  function _checkForProvince() {
    var selected = n$3(
      '[value="'.concat(countrySelector.value, '"]'),
      countrySelector
    );
    ...
    provinceSelector.innerHTML = provinces.reduce((acc, curr) => {
      return (
        acc +
        '<option value="'.concat(curr[0], '">').concat(curr[0], "</option>")
      );
    }, "");
  }
...
var productForm = function productForm(formElement) {
  var config =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var { productHandle, ajaxEnabled } = formElement.dataset;
  var { product: selector } = selectors$1j;
  var storeAvailabilityContainer = formElement.querySelector(
    selector.storeAvailability
  );
  var shippingEstimatorButtons = t$6(
    "[data-estimator-trigger]",
    config.container
  );
  var shippingEstimator = shippingEstimatorButtons.map((button) =>
  ...
  product((data) => {
    ...
    var productInventoryJson = formElement.querySelector(
  ...
  var optionChange = (_ref2) => {
    ...
    var selectedVariantOpt = formElement.querySelector(
      ""
        .concat(selector.variantSelect, " ")
        .concat(selector.optionById(variant.id))
    );
    ...
    if (isProductPage && variant.featured_media) {
      if (window.matchMedia("(min-width: 60em)").matches) {
        ...
        if (document.querySelector(".product-thumbnails")) {
          ...
          var allThumbs = document.querySelectorAll(
    ...
    if (isFeaturedProduct && variant.featured_media) {
      ...
      var _image = container.querySelector(
        '[data-media-id="'.concat(variant.featured_media.id, '"]')
      );
...
var getProductMarkup = (handle) => (cb) =>
  fetch(
    ""
      .concat(window.theme.routes.products, "/")
      .concat(encodeURIComponent(handle), "?section_id=quick-add-item")
  )
    .then((res) => res.text())
    .then((data) => cb(data))
    .catch((err) => console.log(err.message));
...
function quickAdd() {
  ...
  var quickAddModalContent = n$3(
    selectors$z.quickAddModalContent,
    quickAddModal
  );
  var quickAddModalWash = n$3(selectors$z.quickAddModalWash, quickAddModal);
  var delegate = new Delegate(document.body);
  [
    e$3(quickAddModalWash, "click", close),
    e$3(n$3(selectors$z.quickAddModalClose, quickAddModal), "click", close),
    e$3(quickAddModal, "keydown", (_ref) => {
      var { keyCode } = _ref;
      if (keyCode === 27) close();
    }),
  ...
  var focusTrap = createFocusTrap(
    n$3(selectors$z.quickAddModalInner, quickAddModal),
    {
      allowOutsideClick: true,
    }
  );
  ...
  function handleClick(event, target) {
    ...
    var { quickAdd: handle } = target.dataset;
    open(handle);
  }
  ...
  function open(handle) {
    ...
    product((html) => {
      ...
      quickAddModalContent.innerHTML = n$3(
        selectors$z.quickAddProduct,
        container
      ).innerHTML;
      ...
      specialityVariantButtons = OptionButtons(
        t$6("[data-option-buttons]", quickAddModalContent)
      ...
      quickAddAnimation === null || quickAddAnimation === void 0
        ? void 0
  ...
  function close() {
    ...
    (_quanityInputEl = quanityInputEl) === null || _quanityInputEl === void 0
      ? void 0
      : _quanityInputEl.quanityInputEl();
    (_specialityVariantBut = specialityVariantButtons) === null ||
    _specialityVariantBut === void 0
      ? void 0
      : _specialityVariantBut.destroy();
    (_dynamicVariantAvaila = dynamicVariantAvailability) === null ||
    _dynamicVariantAvaila === void 0
      ? void 0
      : _dynamicVariantAvaila.unload();
    quickAddAnimation === null || quickAddAnimation === void 0
      ? void 0
...
var storeAvailabilityDrawer = (node) => {
  ...
  var events = [
    e$3(n$3(selectors$y.closeBtn, node), "click", (e) => {
      e.preventDefault();
    ...
    c$1("drawerOverlay:hiding", () => _close(false)),
    c$1("availability:showMore", (_ref2) => {
      var { product, variant, storeList } = _ref2;
  ...
  var _renderAvailabilityList = (storeList) => {
    ...
    setTimeout(() => {
      storeAvailabilityAnimation === null ||
      storeAvailabilityAnimation === void 0
        ? void 0
  ...
  var _renderProductCard = (_ref3, _ref4) => {
    var { featured_image: image, title } = _ref3;
    var {
      title: variant_title,
      featured_image,
      price,
...
var disclosure = (node, container) => {
  ...
  function submitForm(evt) {
    evt.preventDefault();
    var { value } = evt.currentTarget.dataset;
  ...
  var unload = () => {
    disclosureOptions.forEach((o) =>
      o.removeEventListener("click", submitForm)
    );
...
register("footer", {
  ...
  onLoad() {
    ...
    function handleHeaderClick(_ref) {
      var { currentTarget } = _ref;
      var { nextElementSibling: content } = currentTarget;
    ...
    if (cbSelectors) {
      cbSelectors.forEach((selector) => {
        var { disclosure: d } = selector.dataset;
...
var navigation = (node) => {
  ...
  var headerLinks = navDepthOne.querySelectorAll(
    ""
      .concat(selectors$v.navDepthOne, " > li:not(")
      .concat(selectors$v.itemParent, ") > ")
      .concat(selectors$v.navLink)
  );
  ...
  var accountTrigger = node.querySelector(
    "".concat(selectors$v.headerAcccountIcon, " > a")
  );
  var navMenuTrigger = node.querySelectorAll(
    "".concat(selectors$v.navTrigger, " > ").concat(selectors$v.linkParent)
  );
  var { navigationInteraction } = node.dataset;
  ...
  var _openMenu = (target) => {
    if (!target.parentNode.classList.contains("nav--depth-2")) {
      ...
      // Close all submenus
      target.parentNode
        .querySelectorAll(selectors$v.navTrigger)
    ...
    megaNavigationAnimation === null || megaNavigationAnimation === void 0
      ? void 0
  ...
  !(function (r, e) {
    ...
    function s(r, e) {
      ...
      var t,
        n,
        o = a(
          a({}, { strictlyTwoElementsInRangeArrays: !1, progressFn: null }),
          e
        );
      if (
        o.strictlyTwoElementsInRangeArrays &&
        !r.every(function (r, e) {
          return 2 === r.length || ((t = e), (n = r.length), !1);
        })
      )
        throw new TypeError(
          "ranges-sort: [THROW_ID_03] The first argument should be an array and must consist of arrays which are natural number indexes representing TWO string index ranges. However, "
            .concat(t, "th range (")
            .concat(JSON.stringify(r[t], null, 4), ") has not two but ")
            .concat(n, " elements!")
        );
      if (
        !r.every(function (r, e) {
        ...
        throw new TypeError(
          "ranges-sort: [THROW_ID_04] The first argument should be an array and must consist of arrays which are natural number indexes representing string index ranges. However, "
            .concat(t, "th range (")
            .concat(
      ...
      var i = r.length * r.length,
        s = 0;
      return Array.from(r).sort(function (r, e) {
        return (
          o.progressFn && ((s += 1), o.progressFn(Math.floor((100 * s) / i))),
          r[0] === e[0]
            ? r[1] < e[1]
              ? -1
              : r[1] > e[1]
    ...
    function c(e, t) {
      ...
      var c,
        l = { mergeType: 1, progressFn: null, joinRangesThatTouchEdges: !0 };
      if (t) {
        if (!i(t))
          throw new Error(
            "emlint: [THROW_ID_03] the second input argument must be a plain object. It was given as:\n"
              .concat(JSON.stringify(t, null, 4), " (type ")
              .concat(r(t), ")")
          );
        if (
          (c = a(a({}, l), t)).progressFn &&
          i(c.progressFn) &&
          !Object.keys(c.progressFn).length
        )
          c.progressFn = null;
        else if (c.progressFn && "function" != typeof c.progressFn)
          throw new Error(
            'ranges-merge: [THROW_ID_01] opts.progressFn must be a function! It was given of a type: "'
              .concat(r(c.progressFn), '", equal to ')
              .concat(JSON.stringify(c.progressFn, null, 4))
          );
        if (c.mergeType && 1 !== c.mergeType && 2 !== c.mergeType)
          if (n(c.mergeType) && "1" === c.mergeType.trim()) c.mergeType = 1;
          else {
            if (!n(c.mergeType) || "2" !== c.mergeType.trim())
              throw new Error(
                'ranges-merge: [THROW_ID_02] opts.mergeType was customised to a wrong thing! It was given of a type: "'
                  .concat(r(c.mergeType), '", equal to ')
                  .concat(JSON.stringify(c.mergeType, null, 4))
              );
            c.mergeType = 2;
          }
        if ("boolean" != typeof c.joinRangesThatTouchEdges)
          throw new Error(
            'ranges-merge: [THROW_ID_04] opts.joinRangesThatTouchEdges was customised to a wrong thing! It was given of a type: "'
              .concat(r(c.joinRangesThatTouchEdges), '", equal to ')
              .concat(JSON.stringify(c.joinRangesThatTouchEdges, null, 4))
          );
      } else c = a({}, l);
      for (
        var u,
          ...
          g = e
            ...
            .filter(function (r) {
              return void 0 !== r[2] || r[0] !== r[1];
            }),
          d =
            (u = c.progressFn
              ? s(g, {
                  progressFn: function (r) {
                    (f = Math.floor(r / 5)) !== p && ((p = f), c.progressFn(f));
                  },
                })
              : s(g)).length - 1,
          h = d;
        ...
        c.progressFn &&
          (f = Math.floor(78 * (1 - h / d)) + 21) !== p &&
          f > p &&
          ((p = f), c.progressFn(f)),
          (u[h][0] <= u[h - 1][0] ||
            (!c.joinRangesThatTouchEdges && u[h][0] < u[h - 1][1]) ||
            (c.joinRangesThatTouchEdges && u[h][0] <= u[h - 1][1])) &&
            ((u[h - 1][0] = Math.min(u[h][0], u[h - 1][0])),
            (u[h - 1][1] = Math.max(u[h][1], u[h - 1][1])),
            void 0 !== u[h][2] &&
              (u[h - 1][0] >= u[h][0] || u[h - 1][1] <= u[h][1]) &&
              null !== u[h - 1][2] &&
              (null === u[h][2] && null !== u[h - 1][2]
                ? (u[h - 1][2] = null)
                : void 0 !== u[h - 1][2]
                ? 2 === c.mergeType && u[h - 1][0] === u[h][0]
                  ? (u[h - 1][2] = u[h][2])
                  : (u[h - 1][2] += u[h][2])
                : (u[h - 1][2] = u[h][2])),
            u.splice(h, 1),
    ...
    function p(e, t, n) {
      ...
      var s = (a =
          Array.isArray(t) &&
          ((Number.isInteger(t[0]) && t[0] >= 0) || /^\d*$/.test(t[0])) &&
          ((Number.isInteger(t[1]) && t[1] >= 0) || /^\d*$/.test(t[1]))
            ? [Array.from(t)]
            : Array.from(t)).length,
        p = 0;
      a.forEach(function (e, t) {
        if (
          (n && (o = Math.floor((p / s) * 10)) !== i && ((i = o), n(o)),
          !Array.isArray(e))
        )
          throw new TypeError(
            "ranges-apply: [THROW_ID_05] ranges array, second input arg., has "
              .concat(t, "th element not an array: ")
              .concat(JSON.stringify(e, null, 4), ", which is ")
              .concat(r(e))
          );
          ...
          if (!/^\d*$/.test(e[0]))
            throw new TypeError(
              "ranges-apply: [THROW_ID_06] ranges array, second input arg. has "
                .concat(t, "th element, array [")
                .concat(e[0], ",")
                .concat(
                  e[1],
                  "]. That array has first element not an integer, but "
                )
                .concat(r(e[0]), ", equal to: ")
                .concat(
                  JSON.stringify(e[0], null, 4),
                  ". Computer doesn't like this."
                )
            );
          a[t][0] = Number.parseInt(a[t][0], 10);
        }
          ...
          if (!/^\d*$/.test(e[1]))
            throw new TypeError(
              "ranges-apply: [THROW_ID_07] ranges array, second input arg. has "
                ...
                .concat(r(e[1]), ", equal to: ")
                .concat(
                  JSON.stringify(e[1], null, 4),
                  ". Computer doesn't like this."
                )
            );
          a[t][1] = Number.parseInt(a[t][1], 10);
        }
        p += 1;
      });
      var f = c(a, {
          progressFn: function (r) {
            n && (o = 10 + Math.floor(r / 10)) !== i && ((i = o), n(o));
          },
        }),
        g = f.length;
      if (g > 0) {
        var d = e.slice(f[g - 1][1]);
        (e = f.reduce(function (r, t, a, s) {
          n && (o = 20 + Math.floor((a / g) * 80)) !== i && ((i = o), n(o));
          var c = 0 === a ? 0 : s[a - 1][1],
            u = s[a][0];
          return r + e.slice(c, u) + (l(s[a][2]) ? s[a][2] : "");
        }, "")),
          (e += d);
      }
      return e;
    ...
    function f(r) {
      ...
      if (
        ...
        if (e) {
          if (("\n" === t || " " === t) && r.length && " " === r[r.length - 1])
            for (; r.length && " " === r[r.length - 1]; ) r.pop();
          r.push(" " === t || "\n" === t ? t : " ");
        } else {
          if (("\n" === t || " " === t) && r.length && " " === r[0])
            for (; r.length && " " === r[0]; ) r.shift();
          r.unshift(" " === t || "\n" === t ? t : " ");
        }
    }
    function g(r, e) {
      if ("string" == typeof r && r.length) {
        ...
        var i = [];
        if (((n = t), "" === r[0].trim()))
          for (var s = 0, c = r.length; s < c && !r[s].trim(); s++)
            ("\n" !== r[s] || n) && ("\n" === r[s] && (n -= 1), f(i, !0, r[s]));
        var l = [];
        if (((n = t), "" === r.slice(-1).trim()))
          for (var u = r.length; u-- && !r[u].trim(); )
            ("\n" !== r[u] || n) && ("\n" === r[u] && (n -= 1), f(l, !1, r[u]));
        return a
          ? ""
              .concat(i.join(""))
    ...
    function b(r) {
      return /^\d*$/.test(r) ? parseInt(r, 10) : r;
    }
    var y = (function () {
      function t(e) {
        !(function (r, e) {
        ...
        if (n.mergeType && 1 !== n.mergeType && 2 !== n.mergeType)
          if (m(n.mergeType) && "1" === n.mergeType.trim()) n.mergeType = 1;
          else {
            if (!m(n.mergeType) || "2" !== n.mergeType.trim())
              throw new Error(
                'ranges-push: [THROW_ID_02] opts.mergeType was customised to a wrong thing! It was given of a type: "'
                  .concat(r(n.mergeType), '", equal to ')
                  .concat(JSON.stringify(n.mergeType, null, 4))
              );
            n.mergeType = 2;
          }
        this.opts = n;
        ...
        (i = [
          {
            ...
            value: function (e, t, n) {
              ...
              if (s.length > 0)
                throw new TypeError(
                  "ranges-push/Ranges/add(): [THROW_ID_03] Please don't overload the add() method. From the 4th input argument onwards we see these redundant arguments: ".concat(
                  ...
                  if (Array.isArray(e)) {
                    if (e.length) {
                      if (
                        ...
                        return void e.forEach(function (r) {
                          Array.isArray(r) && a.add.apply(a, o(r));
                        });
                      e.length > 1 &&
                        h(b(e[0])) &&
                        h(b(e[1])) &&
                        this.add.apply(this, o(e));
                    }
                    return;
                  }
                  throw new TypeError(
                    'ranges-push/Ranges/add(): [THROW_ID_12] the first input argument, "from" is set ('
                      .concat(
                        JSON.stringify(e, null, 0),
                        ') but second-one, "to" is not ('
                      )
                      .concat(JSON.stringify(t, null, 0), ")")
                  );
                }
                if (!d(e) && d(t))
                  throw new TypeError(
                    'ranges-push/Ranges/add(): [THROW_ID_13] the second input argument, "to" is set ('
                      .concat(
                        JSON.stringify(t, null, 0),
                        ') but first-one, "from" is not ('
                      )
                      .concat(JSON.stringify(e, null, 0), ")")
                  );
                var l = /^\d*$/.test(e) ? parseInt(e, 10) : e,
                  u = /^\d*$/.test(t) ? parseInt(t, 10) : t;
                if ((h(n) && (n = String(n)), !h(l) || !h(u)))
                  throw h(l) && l >= 0
                    ? new TypeError(
                        'ranges-push/Ranges/add(): [THROW_ID_10] "to" value, the second input argument, must be a natural number or zero! Currently it\'s of a type "'
                          .concat(r(u), '" equal to: ')
                          .concat(JSON.stringify(u, null, 4))
                      )
                    : new TypeError(
                        'ranges-push/Ranges/add(): [THROW_ID_09] "from" value, the first input argument, must be a natural number or zero! Currently it\'s of a type "'
                          .concat(r(l), '" equal to: ')
                          .concat(JSON.stringify(l, null, 4))
                      );
                if (d(n) && !m(n) && !h(n))
                  throw new TypeError(
                    "ranges-push/Ranges/add(): [THROW_ID_08] The third argument, the value to add, was given not as string but "
                      .concat(r(n), ", equal to:\n")
                      .concat(JSON.stringify(n, null, 4))
                  );
                if (
                  ...
                  if (
                    ((this.last()[1] = u),
                    this.last()[2],
                    null !== this.last()[2] && d(n))
                  ) {
                    var p =
                      !(d(this.last()[2]) && this.last()[2].length > 0) ||
                      (this.opts &&
                        this.opts.mergeType &&
                        1 !== this.opts.mergeType)
                        ? n
                        : this.last()[2] + n;
                    this.opts.limitToBeAddedWhitespace &&
                      (p = g(p, this.opts.limitLinebreaksCount)),
                      (m(p) && !p.length) || (this.last()[2] = p);
                  }
                } else {
                  this.slices || (this.slices = []);
                  var f =
                    void 0 === n || (m(n) && !n.length)
                      ? [l, u]
                      : [
                          l,
                          u,
                          this.opts.limitToBeAddedWhitespace
                            ? g(n, this.opts.limitLinebreaksCount)
                            : n,
                        ];
                  this.slices.push(f);
                }
          ...
          },
          {
            ...
            value: function (r, e, t) {
              for (
                ...
                a[o - 3] = arguments[o];
              this.add.apply(this, [r, e, t].concat(a));
            },
          },
          {
            key: "current",
            value: function () {
              ...
              return null != this.slices
                ? ((this.slices = c(this.slices, {
                    mergeType: this.opts.mergeType,
                  })),
                  this.opts.limitToBeAddedWhitespace
                    ? this.slices.map(function (e) {
                        return d(e[2])
                          ? [e[0], e[1], g(e[2], r.opts.limitLinebreaksCount)]
                          : e;
                      })
                    : this.slices)
                : null;
          ...
          },
          {
            ...
            value: function (r) {
              if (Array.isArray(r) && r.length) {
                if (!Array.isArray(r[0]) || !h(r[0][0]))
                  throw new Error(
                    "ranges-push/Ranges/replace(): [THROW_ID_11] Single range was given but we expected array of arrays! The first element, ".concat(
                      JSON.stringify(r[0], null, 4),
                      " should be an array and its first element should be an integer, a string index."
                    )
                  );
                this.slices = Array.from(r);
          ...
          },
          {
            key: "last",
            value: function () {
              return void 0 !== this.slices && Array.isArray(this.slices)
    ...
    var _ = function (e) {
        ...
        return "function" == typeof n && n instanceof n && T.call(n) == k;
      },
      x =
    ...
    var L = /^\s+|\s+$/g,
      ...
      F = "object" == r(x) && x && x.Object === Object && x,
      G =
        "object" == ("undefined" == typeof self ? "undefined" : r(self)) &&
        self &&
        self.Object === Object &&
        self,
      z = F || G || Function("return this")();
    function J(r, e, t) {
      if (e != e)
      ...
      for (var n = t - 1, a = r.length; ++n < a; ) if (r[n] === e) return n;
      return -1;
    }
    function M(r) {
      return r != r;
        ...
        !e && t >= n
          ...
          : (function (r, e, t) {
              ...
              e < 0 && (e = -e > a ? 0 : a + e),
                ...
                (a = e > t ? 0 : (t - e) >>> 0),
                (e >>>= 0);
              for (var o = Array(a); ++n < a; ) o[n] = r[n + e];
              return o;
            })(r, e, t)
      );
    }
    var er = function (r, e, t) {
        var n;
        if ((r = null == (n = r) ? "" : X(n)) && (t || void 0 === e))
          return r.replace(L, "");
        if (!r || !(e = X(e))) return r;
        var a = $(r),
          o = $(e);
        return rr(
          a,
          (function (r, e) {
            for (var t = -1, n = r.length; ++t < n && J(e, r[t], 0) > -1; );
            return t;
          })(a, o),
          (function (r, e) {
            for (var t = r.length; t-- && J(e, r[t], 0) > -1; );
            return t;
          })(a, o) + 1
        ).join("");
      },
      tr = /^\[object .+?Constructor\]$/,
      nr = "object" == r(x) && x && x.Object === Object && x,
      ar =
        "object" == ("undefined" == typeof self ? "undefined" : r(self)) &&
        self &&
        self.Object === Object &&
        self,
      or = nr || ar || Function("return this")();
    function ir(r, e, t) {
      switch (t.length) {
        case 0:
          return r.call(e);
        ...
        (function (r, e, t) {
          if (e != e)
            return (function (r, e, t, n) {
              var a = r.length,
                o = t + (n ? 1 : -1);
              for (; n ? o-- : ++o < a; ) if (e(r[o], o, r)) return o;
              return -1;
            })(r, lr, t);
          var n = t - 1,
            a = r.length;
          for (; ++n < a; ) if (r[n] === e) return n;
          return -1;
        })(r, e, 0) > -1
      );
    }
    function cr(r, e, t) {
      for (var n = -1, a = r ? r.length : 0; ++n < a; )
        if (t(e, r[n])) return !0;
      return !1;
    }
    function lr(r) {
    ...
    var pr,
      ...
      mr = (pr = /[^.]+$/.exec((hr && hr.keys && hr.keys.IE_PROTO) || ""))
        ? "Symbol(src)_1." + pr
        : "",
      br = gr.toString,
      yr = dr.hasOwnProperty,
      vr = dr.toString,
      wr = RegExp(
        "^" +
          br
    ...
    function _r(r) {
      var e = -1,
        t = r ? r.length : 0;
      for (this.__data__ = new Sr(); ++e < t; ) this.add(r[e]);
    }
    function xr(r, e) {
      for (var t, n, a = r.length; a--; )
        if ((t = r[a][0]) === (n = e) || (t != t && n != n)) return a;
      return -1;
    }
    function Dr(r, e, t, n) {
      var a = -1,
      ...
      t &&
        (e = (function (r, e) {
          for (var t = -1, n = r ? r.length : 0, a = Array(n); ++t < n; )
            a[t] = e(r[t], t, r);
          return a;
        })(
          e,
        ...
        n
          ? ((o = cr), (i = !1))
          : e.length >= 200 && ((o = ur), (i = !1), (e = new _r(e)));
      r: for (; ++a < s; ) {
        var u = r[a],
          p = t ? t(u) : u;
        if (((u = n || 0 !== u ? u : 0), i && p == p)) {
          for (var f = l; f--; ) if (e[f] === p) continue r;
          c.push(u);
    ...
    (kr.prototype.clear = function () {
      ...
      (kr.prototype.delete = function (r) {
        return this.has(r) && delete this.__data__[r];
      }),
      (kr.prototype.get = function (r) {
        var e = this.__data__;
        if (Er) {
          var t = e[r];
          return "__lodash_hash_undefined__" === t ? void 0 : t;
        }
        return yr.call(e, r) ? e[r] : void 0;
      }),
      (kr.prototype.has = function (r) {
        var e = this.__data__;
        return Er ? void 0 !== e[r] : yr.call(e, r);
      }),
      (kr.prototype.set = function (r, e) {
        return (
          (this.__data__[r] =
            Er && void 0 === e ? "__lodash_hash_undefined__" : e),
          this
        );
      }),
      ...
      (Or.prototype.delete = function (r) {
        var e = this.__data__,
          t = xr(e, r);
        return !(t < 0) && (t == e.length - 1 ? e.pop() : qr.call(e, t, 1), !0);
      }),
      ...
      (Or.prototype.has = function (r) {
        return xr(this.__data__, r) > -1;
      }),
      (Or.prototype.set = function (r, e) {
        var t = this.__data__,
          n = xr(t, r);
      ...
      (Sr.prototype.delete = function (r) {
        return jr(this, r).delete(r);
      }),
      (Sr.prototype.get = function (r) {
        return jr(this, r).get(r);
      }),
      (Sr.prototype.has = function (r) {
        return jr(this, r).has(r);
      }),
      (Sr.prototype.set = function (r, e) {
        return jr(this, r).set(r, e), this;
      }),
    ...
    var Ir = (function (r, e) {
        return (
          (e = Ar(void 0 === e ? r.length - 1 : e, 0)),
          function () {
            for (
              var t = arguments, n = -1, a = Ar(t.length - e, 0), o = Array(a);
              ++n < a;
    ...
    /*! https://mths.be/punycode v1.4.1 by @mathias */ function Gr(r) {
      throw new RangeError(Pr[r]);
    }
    function zr(r, e) {
      for (var t = r.length, n = []; t--; ) n[t] = e(r[t]);
      return n;
    }
    function Jr(r, e) {
      var t = r.split("@"),
      ...
      return (
        ...
        n + zr((r = r.replace(Vr, ".")).split("."), e).join(".")
      );
    }
    function Mr(r) {
      for (var e, t, n = [], a = 0, o = r.length; a < o; )
        (e = r.charCodeAt(a++)) >= 55296 && e <= 56319 && a < o
          ? 56320 == (64512 & (t = r.charCodeAt(a++)))
    ...
    function Zr(r, e, t) {
      var n = 0;
      for (r = t ? Wr(r / 700) : r >> 1, r += Wr(r / e); r > 455; n += 36)
        r = Wr(r / 35);
      return Wr(n + (36 * r) / (r + 38));
    }
    function Kr(r) {
      var e,
        t,
        ...
        h = 128,
        m = 72;
      for ((t = r.lastIndexOf("-")) < 0 && (t = 0), n = 0; n < t; ++n)
        r.charCodeAt(n) >= 128 && Gr("not-basic"), f.push(r.charCodeAt(n));
      for (a = t > 0 ? t + 1 : 0; a < g; ) {
        for (
          o = d, i = 1, s = 36;
          a >= g && Gr("invalid-input"),
            ((c =
              (p = r.charCodeAt(a++)) - 48 < 10
                ? p - 22
                : p - 65 < 26
                ? p - 65
                : p - 97 < 26
              ...
              Gr("overflow"),
            (d += c * i),
            !(c < (l = s <= m ? 1 : s >= m + 26 ? 26 : s - m));
          s += 36
        )
          i > Wr(Br / (u = 36 - l)) && Gr("overflow"), (i *= u);
        (m = Zr(d - o, (e = f.length + 1), 0 == o)),
          Wr(d / e) > Br - h && Gr("overflow"),
          (h += Wr(d / e)),
          (d %= e),
          f.splice(d++, 0, h);
      }
    ...
    function Qr(r) {
      var e,
        ...
        h,
        m = [];
      for (f = (r = Mr(r)).length, e = 128, t = 0, o = 72, i = 0; i < f; ++i)
        (p = r[i]) < 128 && m.push(Fr(p));
      for (n = a = m.length, a && m.push("-"); n < f; ) {
        for (s = Br, i = 0; i < f; ++i) (p = r[i]) >= e && p < s && (s = p);
        for (
          s - e > Wr((Br - t) / (g = n + 1)) && Gr("overflow"),
            t += (s - e) * g,
            e = s,
            i = 0;
          i < f;
          ...
          if (((p = r[i]) < e && ++t > Br && Gr("overflow"), p == e)) {
            for (
              c = t, l = 36;
              ...
              (h = c - u),
                (d = 36 - u),
                m.push(Fr(Yr(u + (h % d), 0))),
                (c = Wr(h / d));
            m.push(Fr(Yr(c, 0))), (o = Zr(t, g, n == a)), (t = 0), ++n;
          }
        ++t, ++e;
      }
      return m.join("");
    ...
    var Xr = {
        version: "1.4.1",
        ucs2: { decode: Mr, encode: $r },
        toASCII: function (r) {
          return Jr(r, function (r) {
            return Ur.test(r) ? "xn--" + Qr(r) : r;
          });
        },
        toUnicode: function (r) {
          return Jr(r, function (r) {
            return Hr.test(r) ? Kr(r.slice(4).toLowerCase()) : r;
          });
        },
        encode: Qr,
        decode: Kr,
      ...
      ee = function (r, e) {
        ...
        var t = !0;
        e.named && (t = !1);
        void 0 !== e.numeric && (t = e.numeric);
        for (
          var n = e.special || { '"': !0, "'": !0, "<": !0, ">": !0, "&": !0 },
            a = Xr.ucs2.decode(r),
            o = [],
            i = 0;
          i < a.length;
    ...
    var ae = {
      ...
      decode: function (r) {
        if ("string" != typeof r) throw new TypeError("Expected a String");
        return r.replace(/&(#?[^;\W]+;?)/g, function (r, e) {
          var t;
          if ((t = /^#(\d+);?$/.exec(e)))
            return Xr.ucs2.encode([parseInt(t[1], 10)]);
          if ((t = /^#[Xx]([A-Fa-f0-9]+);?/.exec(e)))
            return Xr.ucs2.encode([parseInt(t[1], 16)]);
          var n = /;$/.test(e),
            a = n ? e.replace(/;$/, "") : e,
            o = ne[a] || (n && ne[e]);
    ...
    !(function (r, e, t) {
      ...
      (p[n] =
        ...
        p["[object Uint32Array]"] =
          !0),
        (p["[object Error]"] = p[a] = p["[object WeakMap]"] = !1);
      var f = "object" == r(x) && x && x.Object === Object && x,
        g =
          "object" == ("undefined" == typeof self ? "undefined" : r(self)) &&
          self &&
          self.Object === Object &&
          self,
        d = f || g || Function("return this")(),
        h = t && !t.nodeType && t,
        m = h && e && !e.nodeType && e,
        b = m && m.exports === h;
      function y(r, e) {
        return r.set(e[0], e[1]), r;
      }
      function v(r, e) {
        return r.add(e), r;
      }
      function w(r, e, t, n) {
        var a = -1,
          o = r ? r.length : 0;
        for (n && o && (t = r[++a]); ++a < o; ) t = e(t, r[a], a, r);
        return t;
      }
      function q(r) {
        var e = !1;
      ...
      var k = Array.prototype,
        ...
        D = (function () {
          var r = /[^.]+$/.exec((_ && _.keys && _.keys.IE_PROTO) || "");
        ...
        I = d.Symbol,
        B = d.Uint8Array,
        H = T(Object.getPrototypeOf, Object),
        U = Object.create,
        V = S.propertyIsEnumerable,
        P = k.splice,
        W = Object.getOwnPropertySymbols,
        F = C ? C.isBuffer : void 0,
        G = T(Object.keys, Object),
        z = mr(d, "DataView"),
        J = mr(d, "Map"),
        M = mr(d, "Promise"),
        $ = mr(d, "Set"),
      ...
      function lr(r, e, t) {
        var n = r[e];
        (j.call(r, e) && Ar(n, t) && (void 0 !== t || e in r)) || (r[e] = t);
      }
      function ur(r, e) {
        for (var t = r.length; t--; ) if (Ar(r[t][0], e)) return t;
        return -1;
      }
      function pr(r, e, t, l, u, f, g) {
        var d;
        if ((l && (d = f ? l(r, u, f, g) : l(r)), void 0 !== d)) return d;
        if (!Sr(r)) return r;
        var h = Tr(r);
        if (h) {
          if (
          ...
          if (kr(r))
            return (function (r, e) {
              if (e) return r.slice();
              var t = new r.constructor(r.length);
              return r.copy(t), t;
            })(r, e);
          if ("[object Object]" == m || m == n || (b && !f)) {
            if (q(r)) return f ? r : {};
            if (
              ((d = (function (r) {
                return "function" != typeof r.constructor || wr(r)
                  ? {}
                  : ((e = H(r)), Sr(e) ? U(e) : {});
                var e;
              })(b ? {} : r)),
              ...
              switch (e) {
                ...
                case i:
                  return (function (r, e, t) {
                    return w(e ? t(A(r), !0) : A(r), y, new r.constructor());
                  })(r, n, t);
                case "[object Number]":
                case "[object String]":
                  return new a(r);
                case "[object RegExp]":
                  return (function (r) {
                    var e = new r.constructor(r.source, c.exec(r));
                    return (e.lastIndex = r.lastIndex), e;
                  })(r);
                case s:
                  return (function (r, e, t) {
                    return w(e ? t(E(r), !0) : E(r), v, new r.constructor());
                  })(r, n, t);
                case "[object Symbol]":
                  return (o = r), nr ? Object(nr.call(o)) : {};
              }
              var o;
            })(r, m, pr, e);
          }
        ...
        return (
          (function (r, e) {
            for (
              var t = -1, n = r ? r.length : 0;
              ++t < n && !1 !== e(r[t], t, r);

            );
          })(k || r, function (n, a) {
            k && (n = r[(a = n)]), lr(d, a, pr(n, e, t, l, a, r, g));
          }),
          d
        );
      }
      function fr(r) {
        return (
          ...
          ) && (Or(r) || q(r) ? N : l).test(qr(r))
        );
      }
      function gr(r) {
        var e = new r.constructor(r.byteLength);
        return new B(e).set(new B(r)), e;
      }
      function dr(r, e, t, n) {
        t || (t = {});
      ...
      (ar.prototype.clear = function () {
        ...
        (ar.prototype.delete = function (r) {
          return this.has(r) && delete this.__data__[r];
        }),
        (ar.prototype.get = function (r) {
          ...
          return j.call(e, r) ? e[r] : void 0;
        }),
        (ar.prototype.has = function (r) {
          var e = this.__data__;
          return Z ? void 0 !== e[r] : j.call(e, r);
        }),
        (ar.prototype.set = function (r, e) {
          return (
            (this.__data__[r] =
        ...
        (or.prototype.delete = function (r) {
          var e = this.__data__,
            t = ur(e, r);
          return (
            !(t < 0) && (t == e.length - 1 ? e.pop() : P.call(e, t, 1), !0)
          );
        }),
        (or.prototype.get = function (r) {
          var e = this.__data__,
        ...
        (ir.prototype.delete = function (r) {
          return hr(this, r).delete(r);
        }),
        (ir.prototype.get = function (r) {
          return hr(this, r).get(r);
        }),
        (ir.prototype.has = function (r) {
          return hr(this, r).has(r);
        }),
        (ir.prototype.set = function (r, e) {
          return hr(this, r).set(r, e), this;
        }),
        (sr.prototype.clear = function () {
        ...
        (sr.prototype.set = function (r, e) {
          ...
          if (t instanceof or) {
            var n = t.__data__;
            if (!J || n.length < 199) return n.push([r, e]), this;
            t = this.__data__ = new ir(n);
          }
          return t.set(r, e), this;
        });
      var br = W
          ? T(W, Object)
          : function () {
      ...
      function wr(r) {
        ...
        return r === (("function" == typeof e && e.prototype) || S);
      }
      function qr(r) {
        if (null != r) {
          try {
      ...
      ((z && "[object DataView]" != yr(new z(new ArrayBuffer(1)))) ||
        (J && yr(new J()) != i) ||
        (M && "[object Promise]" != yr(M.resolve())) ||
        ($ && yr(new $()) != s) ||
        (Y && "[object WeakMap]" != yr(new Y()))) &&
        (yr = function (r) {
          var e = R.call(r),
        ...
        return Er(r)
          ...
          : (function (r) {
              ...
              for (var t in Object(r))
                j.call(r, t) && "constructor" != t && e.push(t);
              return e;
            })(r);
      }
    ...
    function oe(r, e) {
      return (function (r, e, t) {
        if ("string" != typeof r || !r.length) return null;
        if (((e && "number" == typeof e) || (e = 0), !r[e + 1])) return null;
        if (
          r[e + 1] &&
          ((!t && r[e + 1].trim()) ||
            (t && (r[e + 1].trim() || "\n\r".includes(r[e + 1]))))
        ...
        if (
          ...
          return e + 2;
        for (var n = e + 1, a = r.length; n < a; n++)
          if (
            r[n] &&
            ((!t && r[n].trim()) ||
              (t && (r[n].trim() || "\n\r".includes(r[n]))))
    ...
    function ie(e, t) {
      ...
      throw new TypeError(
        "string-strip-html/stripHtml(): [THROW_ID_03] "
          .concat(
            t,
            " must be array containing zero or more strings or something falsey. Currently it's equal to: "
          )
          .concat(e, ", that a type of ")
          .concat(r(e), ".")
      );
    }
    return function e(t, n) {
      ...
      function q(r, e, n) {
        if (
          Array.isArray(e.stripTogetherWithTheirContents) &&
          e.stripTogetherWithTheirContents.includes(f.name)
        )
          if (
            Array.isArray(h) &&
            h.some(function (e) {
              return e.name === f.name && e.lastClosingBracketAt < r;
            })
          ) {
            for (var a = h.length; a--; )
              if (h[a].name === f.name) {
                l.has(t[r])
                  ? e.cb({
                      tag: f,
                      deleteFrom: h[a].lastOpeningBracketAt,
                      deleteTo: r,
                      insert: null,
                      rangesArr: n,
                      proposedReturn: [h[a].lastOpeningBracketAt, r, null],
                    })
                  : e.cb({
                      tag: f,
                      deleteFrom: h[a].lastOpeningBracketAt,
                      ...
                      insert: "",
                      rangesArr: n,
                      proposedReturn: [h[a].lastOpeningBracketAt, r, ""],
                    }),
                  h.splice(a, 1);
                break;
              }
      ...
      function A(r, e, t, n, a, o) {
        var i = "";
        if ((t < a && (i += r.slice(t, a)), n > o + 1)) {
          var s = r.slice(o + 1, n);
          s.includes("\n") && "<" === r[n] ? (i += " ") : (i += s);
        }
        if (!l.has(r[e]) && "!" !== r[e]) {
      ...
      function T(r) {
        if (
          (r.dumpLinkHrefsNearby.enabled &&
            Object.keys(b).length &&
            b.tagName === f.name &&
            f.lastOpeningBracketAt &&
            ((b.openingTagEnds && f.lastOpeningBracketAt > b.openingTagEnds) ||
              !b.openingTagEnds) &&
            (i = !0),
          i)
        ) {
          var e = r.dumpLinkHrefsNearby.putOnNewLine ? "\n\n" : "";
          v = "".concat(e).concat(b.hrefValue).concat(e);
        }
      }
      if ("string" != typeof t)
        throw new TypeError(
          "string-strip-html/stripHtml(): [THROW_ID_01] Input must be string! Currently it's: "
            .concat(r(t).toLowerCase(), ", equal to:\n")
            .concat(JSON.stringify(t, null, 4))
        );
      if (!t || !t.trim()) return t;
      if (null != n && !_(n))
        throw new TypeError(
          "string-strip-html/stripHtml(): [THROW_ID_02] Optional Options Object must be a plain object! Currently it's: "
            .concat(r(n).toLowerCase(), ", equal to:\n")
            .concat(JSON.stringify(n, null, 4))
        );
      function E() {
        i && ((b = {}), (i = !1));
      ...
      var k = {
          ignoreTags: [],
          onlyStripTags: [],
          stripTogetherWithTheirContents: o(u),
          skipHtmlDecoding: !1,
          returnRangesOnly: !1,
          trimOnlySpaces: !1,
          dumpLinkHrefsNearby: {
        ...
        O = a(a({}, k), n);
      (O.ignoreTags = ie(O.ignoreTags, "opts.ignoreTags")),
        (O.onlyStripTags = ie(O.onlyStripTags, "opts.onlyStripTags"));
      var S = !!O.onlyStripTags.length;
      if (
        (O.onlyStripTags.length &&
          O.ignoreTags.length &&
          (O.onlyStripTags = Ir.apply(
            void 0,
            [O.onlyStripTags].concat(o(O.ignoreTags))
          )),
        _(O.dumpLinkHrefsNearby) ||
          (O.dumpLinkHrefsNearby = a({}, k.dumpLinkHrefsNearby)),
        (O.dumpLinkHrefsNearby = k.dumpLinkHrefsNearby),
        _(n) &&
          Object.prototype.hasOwnProperty.call(n, "dumpLinkHrefsNearby") &&
          null != n.dumpLinkHrefsNearby)
      )
        if (_(n.dumpLinkHrefsNearby))
          O.dumpLinkHrefsNearby = a(
            a({}, k.dumpLinkHrefsNearby),
            n.dumpLinkHrefsNearby
          );
        else if (n.dumpLinkHrefsNearby)
          throw new TypeError(
            "string-strip-html/stripHtml(): [THROW_ID_04] Optional Options Object's key dumpLinkHrefsNearby was set to "
              .concat(r(n.dumpLinkHrefsNearby), ", equal to ")
              .concat(
                JSON.stringify(n.dumpLinkHrefsNearby, null, 4),
                ". The only allowed value is a plain object. See the API reference."
              )
          );
      O.stripTogetherWithTheirContents
        ? "string" == typeof O.stripTogetherWithTheirContents &&
          O.stripTogetherWithTheirContents.length > 0 &&
          (O.stripTogetherWithTheirContents = [
            O.stripTogetherWithTheirContents,
          ])
        : (O.stripTogetherWithTheirContents = []);
      ...
      if (
        O.stripTogetherWithTheirContents &&
        Array.isArray(O.stripTogetherWithTheirContents) &&
        O.stripTogetherWithTheirContents.length &&
        !O.stripTogetherWithTheirContents.every(function (r, e) {
          return "string" == typeof r || ((x.el = r), (x.i = e), !1);
        })
      )
        throw new TypeError(
          "string-strip-html/stripHtml(): [THROW_ID_06] Optional Options Object's key stripTogetherWithTheirContents was set to contain not just string elements! For example, element at index "
            .concat(x.i, " has a value ")
            .concat(x.el, " which is not string but ")
            .concat(r(x.el).toLowerCase(), ".")
        );
      O.cb ||
        (O.cb = function (r) {
          var e = r.rangesArr,
      ...
      var D,
        L = new y({ limitToBeAddedWhitespace: !0, limitLinebreaksCount: 2 });
      if (!O.skipHtmlDecoding) for (; t !== ae.decode(t); ) t = ae.decode(t);
      O.trimOnlySpaces || (t = t.trim());
      for (var j = 0, R = t.length; j < R; j++) {
        if (
          (Object.keys(f).length > 1 &&
            f.lastClosingBracketAt &&
            f.lastClosingBracketAt < j &&
            " " !== t[j] &&
            null === w &&
            (w = j),
          ">" === t[j] && (!f || Object.keys(f).length < 2) && j > 1)
        )
          for (var N = j; N--; ) {
            if (void 0 === t[N - 1] || ">" === t[N])
              if (
        ...
        if (
          ("/" !== t[j] ||
            (f.quotes && f.quotes.value) ||
            !Number.isInteger(f.lastOpeningBracketAt) ||
            Number.isInteger(f.lastClosingBracketAt) ||
            (f.slashPresent = j),
          '"' === t[j] || "'" === t[j])
        )
          if (
            ...
            (m.valueEnds = j),
              (m.value = t.slice(m.valueStarts, j)),
              f.attributes.push(m),
              (m = {}),
              (f.quotes = void 0);
            var C = void 0;
            O.dumpLinkHrefsNearby.enabled &&
              f.attributes.some(function (r) {
                if (r.name && "href" === r.name.toLowerCase())
                  return (
                    (C = ""
                      .concat(O.dumpLinkHrefsNearby.wrapHeads || "")
                      .concat(r.value)
                      .concat(O.dumpLinkHrefsNearby.wrapTails || "")),
                    !0
                  );
              }) &&
              (b = { tagName: f.name, hrefValue: C });
          } else
            !f.quotes &&
              f.nameStarts &&
              ((f.quotes = {}),
              ...
              m.nameStarts &&
                ...
                m.nameStarts < j &&
                !m.valueStarts &&
                (m.name = t.slice(m.nameStarts, m.nameEnds)));
        if (
          !(
            void 0 === f.nameStarts ||
            void 0 !== f.nameEnds ||
            (t[j].trim() && ((D = t[j]), /[-_A-Za-z0-9]/.test(D)))
          )
        ) {
          if (
            ((f.nameEnds = j),
            (f.name = t.slice(
              f.nameStarts,
              f.nameEnds +
                (">" !== t[j] && "/" !== t[j] && void 0 === t[j + 1] ? 1 : 0)
            )),
            ("!" !== t[f.nameStarts - 1] && !f.name.replace(/-/g, "").length) ||
              /^\d+$/.test(f.name[0]))
          ) {
            f = {};
            continue;
          ...
          if ("<" === t[j]) {
            ...
            O.cb({
              tag: f,
              deleteFrom: f.leftOuterWhitespace,
              deleteTo: j,
              insert: "".concat(I).concat(v).concat(I),
              rangesArr: L,
              proposedReturn: [
                f.leftOuterWhitespace,
                j,
                "".concat(I).concat(v).concat(I),
              ],
            }),
              E(),
              q(j, O, L);
        ...
        if (
          ...
          f.quotes ||
            ...
            f.lastClosingBracketAt ||
            (m.nameStarts = j),
          null !== f.lastOpeningBracketAt &&
            f.lastOpeningBracketAt < j &&
            "/" === t[j] &&
            f.onlyPlausible &&
            (f.onlyPlausible = !1),
          null !== f.lastOpeningBracketAt &&
            f.lastOpeningBracketAt < j &&
            "/" !== t[j] &&
            (void 0 === f.onlyPlausible &&
              ((t[j].trim() && "<" !== t[j]) || f.slashPresent
                ? (f.onlyPlausible = !1)
                : (f.onlyPlausible = !0)),
            t[j].trim() &&
              void 0 === f.nameStarts &&
              ...
              ">" !== t[j] &&
              "!" !== t[j] &&
              ((f.nameStarts = j), (f.nameContainsLetters = !1))),
          f.nameStarts &&
            !f.quotes &&
            t[j].toLowerCase() !== t[j].toUpperCase() &&
            (f.nameContainsLetters = !0),
          ">" === t[j] &&
            void 0 !== f.lastOpeningBracketAt &&
            ((f.lastClosingBracketAt = j),
            (w = null),
            Object.keys(m).length && (f.attributes.push(m), (m = {})),
            O.dumpLinkHrefsNearby.enabled &&
              b.tagName &&
              !b.openingTagEnds &&
              (b.openingTagEnds = j)),
          ...
          if (void 0 === f.lastClosingBracketAt) {
            if (
              f.lastOpeningBracketAt < j &&
              "<" !== t[j] &&
              (void 0 === t[j + 1] || "<" === t[j + 1]) &&
              f.nameContainsLetters
            ) {
              if (
                ((f.name = t
                  .slice(f.nameStarts, f.nameEnds ? f.nameEnds : j + 1)
                  .toLowerCase()),
                O.ignoreTags.includes(f.name) ||
                  (f.onlyPlausible && !s.has(f.name)))
              ) {
                (f = {}), (m = {});
                continue;
              }
              if (
                ((s.has(f.name) || c.has(f.name)) &&
                  (!1 === f.onlyPlausible ||
                    (!0 === f.onlyPlausible && f.attributes.length))) ||
                void 0 === t[j + 1]
              ) {
                T(O);
                var B = A(
                ...
                O.cb({
                  ...
                  deleteFrom: f.leftOuterWhitespace,
                  deleteTo: j + 1,
                  insert: "".concat(B).concat(v).concat(B),
                  rangesArr: L,
                  proposedReturn: [
                    f.leftOuterWhitespace,
                    j + 1,
            ...
            (j > f.lastClosingBracketAt && t[j].trim()) ||
            void 0 === t[j + 1]
          ) {
            var H = f.lastClosingBracketAt === j ? j + 1 : j;
            if (
              (O.trimOnlySpaces &&
                H === R - 1 &&
                null !== w &&
                w < j &&
                (H = w),
              (!S && O.ignoreTags.includes(f.name)) ||
                (S && !O.onlyStripTags.includes(f.name)))
            )
              O.cb({
                tag: f,
                deleteFrom: null,
              ...
              !f.onlyPlausible ||
              (0 === f.attributes.length &&
                f.name &&
                (s.has(f.name.toLowerCase()) || c.has(f.name.toLowerCase()))) ||
              (f.attributes &&
                f.attributes.some(function (r) {
                  return r.equalsAt;
                }))
              ...
              var V = void 0;
              (V =
                "string" == typeof v && v.length
                  ? ""
                      .concat(U)
                      .concat(v)
                      .concat("\n\n" === U ? "\n" : U)
                  : U),
                (0 !== f.leftOuterWhitespace && oe(t, H - 1)) || (V = ""),
                O.cb({
                  tag: f,
                  deleteFrom: f.leftOuterWhitespace,
                  deleteTo: H,
                  insert: V,
                  rangesArr: L,
                  proposedReturn: [f.leftOuterWhitespace, H, V],
                }),
                E(),
                q(j, O, L);
            } else f = {};
        ...
        if ("<" === t[j] && "<" !== t[j - 1]) {
          if (">" === t[oe(t, j)]) continue;
          if (
            f.nameEnds &&
            f.nameEnds < j &&
            !f.lastClosingBracketAt &&
            ((!0 === f.onlyPlausible && f.attributes && f.attributes.length) ||
              !1 === f.onlyPlausible)
          ) {
            var P = A(
              t,
            ...
            O.cb({
              ...
              insert: P,
              rangesArr: L,
              proposedReturn: [f.leftOuterWhitespace, j, P],
            }),
              q(j, O, L),
              (f = {}),
              (m = {});
          ...
          if (
            (void 0 !== f.lastOpeningBracketAt &&
              ...
              f.name &&
              !f.quotes &&
              ((f.lastOpeningBracketAt = void 0), (f.onlyPlausible = !1)),
            !(
              (void 0 !== f.lastOpeningBracketAt && f.onlyPlausible) ||
              f.quotes
            ) &&
              ((f.lastOpeningBracketAt = j),
              (f.slashPresent = !1),
              (f.attributes = []),
              null === g
                ? (f.leftOuterWhitespace = j)
                : O.trimOnlySpaces && 0 === g
                ? (f.leftOuterWhitespace = d || j)
                : (f.leftOuterWhitespace = g),
              "!--" ===
                ""
                  .concat(t[j + 1])
                  .concat(t[j + 2])
            ...
            for (var F = void 0, G = j; G < R; G++)
              if (
                  ...
                  (!W &&
                    "--\x3e" ===
                      ""
                        ...
                        .concat(t[G]))) &&
                  (F = G),
                F && ((F < G && t[G].trim()) || void 0 === t[G + 1]))
              ) {
                var z = G;
                ((void 0 === t[G + 1] && !t[G].trim()) || ">" === t[G]) &&
                  (z += 1);
                var J = A(
                  t,
                  G,
                ...
                O.cb({
                  ...
                  insert: J,
                  rangesArr: L,
                  proposedReturn: [f.leftOuterWhitespace, z, J],
                }),
                  (j = G - 1),
                  ">" === t[G] && (j = G),
                  (f = {}),
        ...
        "" === t[j].trim()
          ? null === g &&
            ...
            void 0 !== f.lastOpeningBracketAt &&
              f.lastOpeningBracketAt < j &&
              f.nameStarts &&
              f.nameStarts < f.lastOpeningBracketAt &&
              j === f.lastOpeningBracketAt + 1 &&
              !h.some(function (r) {
          ...
          : null !== g &&
            (!f.quotes &&
              m.equalsAt > g - 1 &&
              m.nameEnds &&
              m.equalsAt > m.nameEnds &&
              '"' !== t[j] &&
              "'" !== t[j] &&
              (_(m) && f.attributes.push(m),
              (m = {}),
              (f.equalsSpottedAt = void 0)),
            (g = null)),
          " " === t[j] ? null === d && (d = j) : null !== d && (d = null);
      }
      if (L.current()) {
        if (O.returnRangesOnly) return L.current();
        var M = p(t, L.current());
        return O.trimOnlySpaces ? er(M, " ") : M.trim();
      }
      return O.returnRangesOnly ? [] : O.trimOnlySpaces ? er(t, " ") : t.trim();
    };
  });
})(stringStripHtml_umd);
...
var { strings: strings$2 } = window.theme;
var placeholderSVG =
...
function PredictiveSearch(_ref) {
  ...
  var { emit, getState, hydrate, on } = a({
    count: 0,
  });
  var types = [
    show_articles && PredictiveSearch$1.TYPES.ARTICLE,
    show_pages && PredictiveSearch$1.TYPES.PAGE,
    show_products && PredictiveSearch$1.TYPES.PRODUCT,
  ].filter(Boolean);
  var instance = new PredictiveSearch$1({
    resources: {
      ...
      options: {
        ...
        fields: [
          PredictiveSearch$1.FIELDS.TITLE,
          PredictiveSearch$1.FIELDS.PRODUCT_TYPE,
          PredictiveSearch$1.FIELDS.VARIANTS_TITLE,
          PredictiveSearch$1.FIELDS.VENDOR,
        ],
      },
    },
  });
  ...
  function renderResults(results) {
    var { articles, pages, products } = results;
    var resultsMarkup = "";

    if (products) {
      // Render product results
      resultsMarkup += renderGroup(
        products,
        strings$2.search.headings.products,
        (_ref4) => {
          var { url, image, title, price, vendor } = _ref4;
          var formattedPrice = formatMoney$1(price);
          var subheading = [
            show_vendor && vendor,
            show_price && strip(formattedPrice),
          ]
            .filter(Boolean)
            .join(" • ");
          return renderResult({
    ...
    if (pages) {
      ...
      resultsMarkup += renderGroup(
        pages,
        strings$2.search.headings.pages,
        (_ref5) => {
          var { url, image, title, body } = _ref5;
          return renderResult({
            url,
            image,
            heading: title,
    ...
    if (articles) {
      ...
      resultsMarkup += renderGroup(
        articles,
        strings$2.search.headings.articles,
        (_ref6) => {
          var { url, image, title, body } = _ref6;
          return renderResult({
            url,
            image,
            heading: title,
    ...
    if (resultsMarkup == "") {
      return '\n        <div class="quick-search__no-results">\n          '.concat(
        strings$2.search.no_results,
        "\n        </div>\n      "
      );
    }

    var viewAll =
      '\n      <div class="quick-search__view-all accent">\n        <button type="submit">'.concat(
        strings$2.search.view_all,
        " &rarr;</button>\n      </div>\n    "
      );
  ...
  function renderGroup(items, heading, cb) {
    var headingMarkup =
      '<div class="quick-search__header type-heading-meta overline">'.concat(
        heading,
        "</div>"
      );
  ...
  function renderResult(_ref7) {
    var { url, image, heading, subheading } = _ref7;
    var img = image
      ? '<img class="image__img lazyload" data-src="'
          .concat(getSizedImageUrl(image, "120x"), '" alt="')
          .concat(heading, '" />')
      : placeholderSVG;
    return '\n      <a class="quick-search__result" href="'
      ...
      .concat(
        img,
        '</div>\n        <div class="quick-search__result-details">\n          <div class="quick-search__result-heading type-body-regular">'
      )
      .concat(
        heading,
        '</div>\n          <div class="quick-search__result-subheading type-body-small">'
      )
      .concat(subheading, "</div>\n        </div>\n      </a>\n    ");
  }
...
var quickSearch = (opts) => {
  ...
  var settings = container.querySelector(selectors$u.settings);
...
function n(n) {
  if (n) {
    var o,
      ...
      c = tabbable_1(n);
    if (!n.querySelector("[data-lockbox]")) {
      (o = t$2({
        onfocus: function () {
          var e = c[c.length - 1];
          e && e.focus();
    ...
    return function () {
      n.removeChild(o), n.removeChild(i), r.focus();
    };
  }
}
...
function mobileQuickSearch(node) {
  ...
  search.on("success", (_ref) => {
    var { markup } = _ref;
    resultsContainer.classList.add(classes$6.visible);
    resultsContainer.innerHTML = markup;
  });

  function handleInput(e) {
    if (e.target.value === "")
      resultsContainer.classList.remove(classes$6.visible);
  ...
  function close(e) {
    e && e.preventDefault();
    document
      .querySelectorAll('[aria-controls="'.concat(node.id, '"]'))
      .forEach((control) => {
        control.setAttribute("aria-expanded", false);
      });
  ...
  function open() {
    ...
    setTimeout(() => {
      ...
      node.querySelectorAll(
        ""
          .concat(sel$3.primary, " > ")
          .concat(sel$3.listItem, ", ")
          .concat(sel$3.footer, " > li, ")
          .concat(sel$3.footer, " > form > li")
      );
...
register("header", {
  ...
  onLoad() {
    var { enableQuickCart, enableQuickAddToCart } = document.body.dataset;
    ...
    if (enableQuickCart === "true" || enableQuickAddToCart === "true") {
      c$1("cart:updated", (state) => {
        var cartCountInner = cartCount.querySelector(
          selectors$t.cartCountInner
        );
  ...
  _openMenu(e) {
    ...
    e.preventDefault();
    (_this$menu = this.menu) === null || _this$menu === void 0
      ? void 0
      : _this$menu.open();
  },
  ...
  _initDisclosure() {
    var languageSelectorContainer = this.container.querySelector(
      selectors$t.languageSelector
    );
    var currencySelectorContainer = this.container.querySelector(
      selectors$t.currencySelector
    );

    if (languageSelectorContainer) {
      this.languageTrigger = languageSelectorContainer.querySelector(
        selectors$t.disclosure
      );
      var { disclosure: d } = this.languageTrigger.dataset;
    ...
    if (currencySelectorContainer) {
      ...
      var { disclosure: _d } = this.currencyTrigger.dataset;
      this.crossBorder[_d] = disclosure(
  ...
  onUnload() {
    ...
    (_this$menu2 = this.menu) === null || _this$menu2 === void 0
      ? void 0
      : _this$menu2.destroy();
...
function Popup(container) {
  ...
  var { id, popupType, timeout } = container.dataset;
  ...
  var popupTypes = {
    ...
    popup: () => {
      if (!window.Shopify.designMode) {
        ...
        events.push(
          e$3([closeBtn], "click", (e) => {
            e.preventDefault();
            hidePopup();
          })
        );
        events.push(
          e$3(container, "keydown", (_ref) => {
            var { keyCode } = _ref;
  ...
  function showPopup() {
    ...
    popupAnimation === null || popupAnimation === void 0
      ? void 0
      : popupAnimation.open();
  }
...
register("utility-bar", {
  ...
  onLoad() {
    ...
    this.events = [
      e$3(window, "resize", debounce(this._matchContentWidths, 150)),
    ];
  ...
  _initSlider() {
    import(flu.chunks.flickity).then((_ref) => {
      var { Flickity } = _ref;
      var { timing } = this.container.dataset;
      slideshowOpts$1.autoPlay = parseInt(timing, 10);
      this.slideshow = new Flickity(
        this.sliderContainer,
        _objectSpread2(
          _objectSpread2({}, slideshowOpts$1),
          {},
          {
            on: {
  ...
  _matchContentWidths() {
    ...
    var disclosureContainer = n$3(
      selectors$s.disclosureContainer,
      this.container
    );
    ...
    if (socialWidth > disclosureWidth) {
      disclosureContainer.setAttribute(
        "style",
        "width:".concat(socialWidth, "px")
      );
    } else {
      socialContainer.setAttribute(
        "style",
        "width:".concat(disclosureWidth, "px")
      );
    }
  },
...
register("collapsible-row-list", {
  ...
  onBlockSelect(_ref) {
    ...
    var { parentNode: group, nextElementSibling: content } = label;
...
register("collection-list", {
  onLoad() {
    this.carouselContainer = this.container.querySelector(
      selectors$p.carouselContainer
    );
    this.carousel = carousel(this.container);
  },

  onBlockSelect(_ref) {
    var { target: slide } = _ref;
...
register("featured-collection-row", {
  ...
  onUnload() {
    ...
    this.carousel.unload();
    (_this$animateFeatured = this.animateFeaturedCollectionRow) === null ||
    _this$animateFeatured === void 0
      ? void 0
      : _this$animateFeatured.destroy();
  },
...
function Media(node) {
  ...
  function initElement(el) {
    var { mediaId, mediaType } = el.dataset;
...
var variantPopup = (node) => {
  ...
  var _variantPopupHandler = (e) => {
    e.preventDefault();
    var { modalContentId } = e.target.dataset;
...
var reviewsDrawer = (node) => {
  ...
  var open = () => {
    node.classList.add("is-visible");
    r$1("drawerOverlay:show");
    var reviewsToggle = node.querySelector(
...
register("featured-product", {
  onLoad() {
    ...
    var productFormContainer = this.container.querySelector(
      selectors$k.productForm
    );
    ...
    if (productFormContainer) {
      ...
      this.optionButtons = OptionButtons(
        t$6("[data-option-buttons]", this.container)
      );
...
var {
  strings: { accessibility: strings$1 },
} = theme;
...
register("product-recommendations", {
  ...
  _getProductRecommendations() {
    var { sectionId, productId, limit } = this.container.dataset; // Build request URL

    var requestUrl = ""
      .concat(window.theme.routes.productRecommendations, "?section_id=")
      .concat(sectionId, "&limit=")
      .concat(limit, "&product_id=")
      .concat(productId); // Create request and submit it using Ajax
...
register("shoppable", {
  onLoad() {
    ...
    this.events = [
      ...
      e$3(this.container, "keydown", (_ref) => {
        var { keyCode } = _ref;
  ...
  _clickOutsideHandler(e) {
    if (
      !e.target.closest(selectors$i.productCard) &&
  ...
  onUnload() {
    ...
    (_this$animateShoppabl = this.animateShoppable) === null ||
...
var pageDots = (container, slider, slideCount) => {
  ...
  var _handlePageDot = (e) => {
    ...
    if (slideCount > 2) {
      var { slideIndex } = e.target.dataset;
...
register("slideshow", {
  ...
  _initSlideshow() {
    import(flu.chunks.flickity).then((_ref) => {
      ...
      var { timer, slideCount } = this.container.dataset;
      slideshowOpts.autoPlay = parseInt(timer);

      if (this.slides.length > 1) {
        this.slideshow = new Flickity(
          this.slideshowContainer,
          _objectSpread2({}, slideshowOpts)
        );
  ...
  _clickListener(evt, slideshow) {
    var { control } = evt.target.dataset;
...
register("slideshow-split", {
  ...
  onLoad() {
    ...
    this.autoPlayListeners = [
      e$3(window, "click", () => this._handleAutoPlay()),
      e$3(window, "touchstart", () => this._handleAutoPlay()),
    ];
    this.observer = null;
  },
  ...
  _initSlideshow() {
    import(flu.chunks.flickity).then((_ref) => {
      ...
      this.observer = new IntersectionObserver((_ref2) => {
        var [{ isIntersecting: visible }] = _ref2;
  ...
  onUnload() {
    ...
    this.slideshow && this.slideshow.destroy();
    this.events.forEach((unsubscribe) => unsubscribe());
    (_this$animateSlidesho = this.animateSlideshowSplit) === null ||
    _this$animateSlidesho === void 0
      ? void 0
      : _this$animateSlidesho.destroy();
...
register("video", {
  ...
  _initPlayer() {
    import(flu.chunks.video).then((_ref) => {
      var { Video } = _ref;
      var { videoId, videoType } = this.container.dataset;
  ...
  onUnload() {
    ...
    (_this$animateSectionI = this.animateSectionIntroduction) === null ||
    _this$animateSectionI === void 0
      ? void 0
      : _this$animateSectionI.destroy();
  },
});
...
register("quote", {
  ...
  onLoad() {
    import(flu.chunks.flickity).then((_ref) => {
      var { Flickity } = _ref;
      var { timer } = this.container.dataset;
      slideshowOpts.autoPlay = parseInt(timer);
  ...
  _initNavigation() {
    ...
    this.listeners.push(
      e$3(navPrevButton, "click", () => this.slideshow.previous())
    );
    this.listeners.push(
      e$3(navNextButton, "click", () => this.slideshow.next())
    );
  },
  ...
  onUnload() {
    ...
    (_this$animateQuote = this.animateQuote) === null ||
    _this$animateQuote === void 0
      ? void 0
      : _this$animateQuote.destroy();
  },
});
...
register("location", {
  ...
  _initMap() {
    ...
    var { sectionId } = this.container.dataset;
        ...
        (res, status) => {
          if (res.length === 0) {
            return console.error(
              "Google Maps Geocoding failed, reason: ".concat(status)
            );
          }
          ...
          var map = new google.maps.Map(
            this.container.querySelector(selectors$c.mapElement),
            {
              center: latLong,
              zoom: 12,
              styles: data.styles,
  ...
  onUnload() {
    ...
    (_this$animateLocation = this.animateLocation) === null ||
    _this$animateLocation === void 0
      ? void 0
      : _this$animateLocation.destroy();
  },
});
...
register("mosaic-grid-2-column", {
  ...
  onUnload() {
    ...
    (_this$animateMosaicGr = this.animateMosaicGrid) === null ||
    _this$animateMosaicGr === void 0
      ? void 0
      : _this$animateMosaicGr.destroy();
...
register("text-columns-with-images", {
  ...
  onUnload() {
    ...
    (_this$animateTextColu = this.animateTextColumnsWithImages) === null ||
    _this$animateTextColu === void 0
      ? void 0
      : _this$animateTextColu.destroy();
  },
});
...
register("cart", {
      ...
      this._updateLineItemQuantity(key, quantity).then(() => {
        this._renderView().then(() => {
          if (
            ...
            var quantityInput = this.container.querySelector(
              ""
                .concat(selectors$7.quantityInput, "[data-line-item-key='")
                .concat(key, "']")
            );
  ...
  _handleQuantityButton(evt) {
    var { quantityButton } = evt.target.closest(
      selectors$7.quantityButton
    ).dataset;
    var quantityWrapper = evt.target.closest(selectors$7.quantityWrapper);
    var quantityInput = quantityWrapper.querySelector(
  ...
  _renderView() {
    ...
    return _asyncToGenerator(function* () {
      var url = ""
        ...
        .concat(_this2.container.dataset.sectionId);
      return fetch(url, {
        credentials: "include",
      })
        .then((res) => res.text())
...
function Lightbox(node) {
  ...
  if (images.length > 1) {
    ...
    (_slider = slider) === null || _slider === void 0
      ? void 0
      : _slider.on("scroll", (progress) => {
          _resetZoom();
    ...
    (_slider2 = slider) === null || _slider2 === void 0
      ? void 0
      : _slider2.on("select", () => {
          ...
          u$2(
            navItems[
              (_slider3 = slider) === null || _slider3 === void 0
                ? void 0
                : _slider3.selectedIndex
            ],
            classes$3.active
          );
          navItems[
            (_slider4 = slider) === null || _slider4 === void 0
              ? void 0
              : _slider4.selectedIndex
          ].scrollIntoView({
            behavior: "smooth",
            inline: "nearest",
          });
  ...
  var events = [
    e$3(n$3(selectors$6.close, node), "click", (e) => {
      e.preventDefault();
      close();
    }),
    ...
    e$3(navItems, "click", (e) => {
      ...
      (_slider5 = slider) === null || _slider5 === void 0
        ? void 0
        : _slider5.select(index);
    }),
    e$3(images, "click", (e) => {
      e.preventDefault();
    ...
    e$3(previousButton, "click", () => {
      ...
      return (_slider6 = slider) === null || _slider6 === void 0
        ? void 0
        : _slider6.previous();
    }),
    e$3(nextButton, "click", () => {
      ...
      return (_slider7 = slider) === null || _slider7 === void 0
        ? void 0
        : _slider7.next();
    }),
  ];
  ...
  function open(id) {
    ...
    setTimeout(() => {
      ...
      var { slideIndex } = image.dataset;
      (_slider8 = slider) === null || _slider8 === void 0
        ? void 0
        : _slider8.select(slideIndex, false, true);
    }, 50);
  }
  ...
  function destroy() {
    ...
    events.forEach((unsubscribe) => unsubscribe());
    (_slider9 = slider) === null || _slider9 === void 0
      ? void 0
      : _slider9.destroy();
  }
...
var heightObserver = (callback) => {
  ...
  var check = () => {
    var changedEntries = observables
      .filter((obj) => {
...
register("product", {
  onLoad() {
    ...
    var productFormContainer = this.container.querySelector(
      selectors$5.productForm
    );
    var inYourSpaceButton = this.container.querySelector(
    ...
    this.productDetails = this.container.querySelector(
      selectors$5.productDetailsWrapper
    );
    this.variantPopup = variantPopup(this.container);
  ...
  _initSlider() {
    import(flu.chunks.flickity).then((_ref3) => {
      var { Flickity } = _ref3;
      var imagesContainer = this.container.querySelector(
        selectors$5.imagesContainer
      );
            ...
            on: {
              ...
              change: () => {
                ...
                if (
                  ...
                  var newImageMedia = n$3(
                    ".media",
                    this.carousel.selectedElement
                  );
                  var inYourSpaceButton = n$3(
                    selectors$5.inYourSpace,
                    this.container
                  );
  ...
  onUnload() {
    var _this$resizeObserver,
      ...
      _this$complementaryPr,
      _this$animateProduct;
    ...
    _this$resizeObserver === void 0
      ? void 0
      : _this$resizeObserver.unload();
    (_this$scroller = this.scroller) === null || _this$scroller === void 0
      ? void 0
      : _this$scroller.scroller.destroy();
    (_this$variantAvailabi = this.variantAvailability) === null ||
    _this$variantAvailabi === void 0
      ? void 0
      : _this$variantAvailabi.unload();
    (_this$complementaryPr = this.complementaryProducts) === null ||
    _this$complementaryPr === void 0
      ? void 0
      : _this$complementaryPr.unload();
    (_this$animateProduct = this.animateProduct) === null ||
    _this$animateProduct === void 0
      ? void 0
      : _this$animateProduct.destroy();
  ...
  !(function (t) {
    ...
    var p,
      S =
        "undefined" == typeof window &&
        "undefined" != typeof commonjsGlobal &&
        "function" == typeof commonjsRequire,
      b =
        !S &&
        t.navigator &&
    ...
    (U.prototype.toString = function () {
      ...
      (L.prototype.toString = function () {
        return (
          ...
          (this.user &&
            u(this.user) + (this.pass && ":" + u(this.pass)) + "@") +
          (this.host && this.host) +
          (this.port && ":" + this.port) +
          (this.path && this.path) +
...
function Collection(e) {
  var r = new t$1(e || window.location.href),
    n = r.paths().indexOf("collections") > 0 ? 3 : 2;
  function o(t) {
    var e = r.paths().slice(0, n);
    r.paths([].concat(e, [t]));
  }
  function u() {
    var t = r.paths().filter(Boolean);
  ...
  return {
    getState: function () {
      return {
        ...
        sort_by: r.query.sort_by || null,
        tags: u(),
        url: r.toString().replace(/%20/g, "+"),
      };
    },
    ...
    setSort: function (t, e) {
      return (r.query.sort_by = t), e(this.getState());
    },
    clearSort: function (t) {
      return delete r.query.sort_by, t(this.getState());
    },
    clearAll: function (t) {
      return delete r.query.sort_by, o(""), t(this.getState());
    },
  };
}
...
function e(e) {
  if (t()) return JSON.parse(localStorage.getItem("neon_" + e));
}
function r(e, r) {
  if (t()) return localStorage.setItem("neon_" + e, r);
}
...
var sidebar = (node) => {
  ...
  function collectionUpdated(evt) {
    var updatedFilterItems = t$6(
      "".concat(sel$2.sidebarForm, " ").concat(sel$2.filterItemLabel),
      evt.doc
    );
    updatedFilterItems.forEach((element) => {
      updateInnerHTML(
        ""
          .concat(sel$2.sidebarForm, " ")
          .concat(sel$2.filterItemLabel, '[for="')
          .concat(element.getAttribute("for"), '"]'),
        evt.doc
      );
    });
  }
  ...
  function handleChange(evt) {
    var { sort, filter, rangeInput } = evt.target.dataset;
  ...
  function handleClick(evt) {
    // evt.preventDefault();
    var { heading } = evt.target.dataset;

    if (heading) {
      evt.preventDefault();
      var { nextElementSibling: content } = evt.target;
      slideStop(content);
...
var flyout = (node) => {
  ...
  var events = [
    e$3(t$6(sel$1.filter, node), "click", clickFlyoutTrigger),
    e$3(node, "keydown", (_ref) => {
      var { keyCode } = _ref;
...
var filtering = (container) => {
  ...
  function syncForms(target) {
    ...
    targetInputs.forEach((targetInput) => {
      if (targetInput.type === "checkbox" || targetInput.type === "radio") {
        var { valueEscaped } = targetInput.dataset;
        var items = t$6(
          "input[name='"
            .concat(targetInput.name, "'][data-value-escaped='")
            .concat(valueEscaped, "']")
        );
        items.forEach((input) => {
  ...
  function uncheckFilters(targets) {
    ...
    targets.forEach((target) => {
      ...
      var { name, valueEscaped } = target.dataset;
      selector = "input[name='"
        .concat(name, "'][data-value-escaped='")
        .concat(valueEscaped, "']")
        .concat(selector);
    });
...
register("collection", {
  ...
  onLoad() {
    var { collectionItemCount, paginationType } = this.container.dataset;
    if (!parseInt(collectionItemCount)) return;
    this.paginationType = paginationType;
    this.paginated = this.paginationType === "paginated";
    this.infiniteScrollTrigger = n$3(
      selectors$3.infiniteScrollTrigger,
      this.container
    );
  ...
  _renderView(searchParams) {
    ...
    fetch(url, {
      ...
      .then((res) => {
        ...
        n$3(selectors$3.filterFlyoutForm, this.container).innerHTML =
          filterFlyoutForm;
...
register("search", {
  onLoad() {
    var { searchItemCount } = this.container.dataset;
    ...
    fetch(url, {
      ...
      .then((res) => {
        ...
        _this$animateSearch === void 0
          ? void 0
          : _this$animateSearch.updateContents();
        i$1(loading, "is-active");
        r$1("collection:updated");
      });
  },
...
register("login", {
  ...
  _toggleRecoverPasswordForm() {
    var recoverPasswordForm = this.container.querySelector(
      selectors$1.recoverPasswordForm
    );
  ...
  _resetPasswordSuccess() {
    ...
    var formMessage = this.container.querySelector(
      selectors$1.resetFormMessage
...
register("addresses", {
  onLoad() {
    ...
    if (addresses.length) {
      var countryProvinceSelector = new CountryProvinceSelector(
  ...
  _initializeAddressForm(countryProvinceSelector, container) {
    ...
    var provinceWrapper = container.querySelector(
...
register("password", {
  onLoad() {
    ...
    var passwordInput = this.container.querySelector(
...
var availabilityDrawer = document.querySelector(
